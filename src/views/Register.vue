                ...
                <b-col sm="6">
                    <div class="register-form general-information">
                        ...
                        <div class="register-form__body">
                            <SaMuInput :placeholder="$t('form.first_name')" type="text" v-model="dto.firstName" id="first_name"/>
                ...
                <b-col sm="6">
                    <div class="register-form digital-information">
                        ...
                        <div class="register-form__body">
                            ...
                            <SaMuButton size="small" type="submit" id="register-form__submit">{{$t('form.send')}}</SaMuButton>
                        </div>
                    </div>
                </b-col>
            </b-row>
