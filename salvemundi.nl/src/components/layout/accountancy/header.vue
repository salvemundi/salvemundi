<template>
  <div>
      <b-nav>
        ...
        <b-nav-item href="/dashboard/accountancy/settings">{{$t('link_names.settings')}}</b-nav-item>
    </b-nav>
  </div>
</template>
...
export default class AccountancyHeader extends Vue {}
</script>
<style lang="scss">
.nav {
...
<i18n src="@/lang/components/accountancy/header.json"></i18n>